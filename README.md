# Open News Article API with Laravel 5.6
...
NOTE:	The above vital info implies we should only install softwares designed for such systems. Otherwise, the software may not work, usually.
